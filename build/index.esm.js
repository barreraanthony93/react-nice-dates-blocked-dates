...
import { getDate, isToday, format, isSameMonth as isSameMonth$1, startOfMonth, subMonths, addMonths, startOfWeek, endOfWeek, addWeeks, endOfMonth, differenceInCalendarWeeks, differenceInCalendarMonths, isAfter, isBefore, eachDayOfInterval, lightFormat, startOfDay, differenceInDays, set, getMonth as getMonth$1, getYear, eachMonthOfInterval, isSameDay, isValid, parse } from 'date-fns';
...
var isSameMonth = function isSameMonth(date, actualDate) {
  return getMonth$1(date) === getMonth$1(actualDate) && getYear(date) === getYear(actualDate);
};
