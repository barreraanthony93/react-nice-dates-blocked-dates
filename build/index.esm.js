import React, { useRef, useReducer, useLayoutEffect, useEffect, useState, useCallback } from 'react';
import { instanceOf, number, object, objectOf, bool, string, func, node, oneOf } from 'prop-types';
import { getDate, isToday, format, isSameMonth as isSameMonth$1, startOfMonth, subMonths, addMonths, startOfWeek, endOfWeek, addWeeks, endOfMonth, differenceInCalendarWeeks, differenceInCalendarMonths, isAfter, isBefore, eachDayOfInterval, lightFormat, startOfDay, differenceInDays, set, getMonth as getMonth$1, getYear as getYear$1, eachMonthOfInterval, eachYearOfInterval, isSameDay, isValid, parse } from 'date-fns';
...
function CalendarNavigation(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: classnames("nice-dates-navigation_previous", {
      "-disabled": isSameMonth$1(month, minimumDate) || !show
    }),
  ...
  }, show && year), /*#__PURE__*/React.createElement("a", {
    className: classnames("nice-dates-navigation_next", {
      "-disabled": isSameMonth$1(month, maximumDate) || !show
    }),
    onClick: handleNext,
...
function useGrid(_ref) {
  ...
  useLayoutEffect(function () {
    ...
    if (!isSameMonth$1(lastCurrentMonth, currentMonth) && notDragging) {
  ...
  var days = eachDayOfInterval({
    ...
    return /*#__PURE__*/React.createElement(CalendarDay, {
      ...
      modifiers: _objectSpread2(_objectSpread2({}, computeModifiers(modifiers, date)), {}, {
        outside: !isSameMonth$1(date, month),
        wide: isWide
      }),
...
var isSameMonth = function isSameMonth(date, actualDate) {
  return getMonth$1(date) === getMonth$1(actualDate) && getYear$1(date) === getYear$1(actualDate);
};
function CalendarMonth(_ref) {
  ...
  }, /*#__PURE__*/React.createElement("span", null, format(date, 'LLLL', {
    locale: locale
  })));
}
...
function MonthPicker(_ref) {
  ...
  useEffect(function () {
    var allMonths = eachMonthOfInterval({
      start: new Date(getYear$1(actualDate), 0, 1),
      end: new Date(getYear$1(actualDate), 11, 1)
    }).map(function (date) {
...
function CalendarYear(_ref) {
  ...
  }, /*#__PURE__*/React.createElement("span", null, format(date, 'yyyy', {
    locale: locale
  })));
}
  ...
  useEffect(function () {
    var allYears = eachYearOfInterval({
      ...
      return /*#__PURE__*/React.createElement(CalendarYear, {
        ...
        onHover: onDayHover,
        onClick: function onClick() {
          return changeYear(lightFormat(date, 'yyyy'));
        },
        showGrid: showGrid
      });
    });
...
function Calendar(_ref) {
  ...
  var _useState = useState(moment().year()),
    _useState2 = _slicedToArray(_useState, 2),
    year = _useState2[0],
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CalendarNavigation, {
    ...
    open: !show
  }, time === "month" && /*#__PURE__*/React.createElement(MonthPicker, {
    locale: locale,
    minimumDate: minimumDate,
    maximumDate: maximumDate,
  ...
  }), time === "year" && /*#__PURE__*/React.createElement(YearPicker, {
    locale: locale,
    minimumDate: minimumDate,
    maximumDate: maximumDate,
    modifiers: monthModifiers,
